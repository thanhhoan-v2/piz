...
import { createFollowNotification } from "@utils/notification.service"
...
export async function createFollow({
	...
	try {
		...
		await createFollowNotification(followerId, followeeId)
...
export async function getUserFollowers(userId: string) {
	try {
		...
		console.error("[FOLLOW] Error getting followers:", JSON.stringify(error, null, 2))
		throw error
	}
}
...
export async function getUserFollowing(userId: string) {
	try {
		...
		console.error("[FOLLOW] Error getting following users:", JSON.stringify(error, null, 2))
		throw error
	}
}
