...
export default function CollabPage({ params }: { params: Promise<{ roomId: string }> }) {
	...
	const [collabInfo, setCollabInfo] = useState<{ id?: bigint; content?: string; room_id?: string; metadata?: any } | null>(null)
